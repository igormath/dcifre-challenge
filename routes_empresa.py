...
@route_empresa.get("/empresa/{id}/", response_model=schemas.Empresa, status_code=200)
...
@route_empresa.delete("/empresa/{id}", response_model=schemas.Empresa, status_code=200)
...
@route_empresa.put("/empresa/{id}", response_model=schemas.Empresa, status_code=200)
