...
route_obrigacao_acessoria = APIRouter()
...
@route_obrigacao_acessoria.post("/obrigacao_acessoria/", response_model=schemas.ObrigacaoAcessoriaCreate, status_code=201, tags=["Método Post Obrigação Acessória"])
...
@route_obrigacao_acessoria.get("/obrigacao_acessoria/", response_model=List[schemas.ObrigacaoAcessoria], status_code=200, tags=["Métodos Get Obrigação Acessória"])
...
@route_obrigacao_acessoria.get("/obrigacao_acessoria/{id}", response_model=schemas.ObrigacaoAcessoria, status_code=200, tags=["Métodos Get Obrigação Acessória"])
...
@route_obrigacao_acessoria.delete("/obrigacao_acessoria/{id}", response_model=schemas.ObrigacaoAcessoria, status_code=200, tags=["Método Delete Obrigação Acessória"])
...
@route_obrigacao_acessoria.put("/obrigacao_acessoria/{id}", response_model=schemas.ObrigacaoAcessoria, status_code=200, tags=["Método Put Obrigação Acessória"])
